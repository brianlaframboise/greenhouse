...
public class Indexer {
    ...
    private ImmutableSet<StepMethod> indexSteps() {
        ...
        final ProcessBuilder builder = Utils.mavenProcess(projectRoot, "kappamaki:kappamaki-maven-plugin:0.1-SNAPSHOT:index");
        ...
        try {
            ...
            process.waitFor();
            File stepIndex = Utils.joinPaths(projectRoot.getAbsolutePath(), "target", "kappamaki-step-index.properties");
