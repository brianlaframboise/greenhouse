package kappamaki.maven.plugin.index;
...
/**
 * Indexes step definitions for Kappamaki.
 * 
 * @goal index
...
public class IndexMojo extends AbstractMojo {
    ...
    /**
     * Output directory into whick kappamaki-step-index.properties is written.
     * 
    ...
    private void serialize(List<StepMethod> stepMethods) {
        File stepIndex = new File(outputDirectory.getPath() + File.separator + "kappamaki-step-index.properties");
